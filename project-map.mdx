...
| --- | --- | --- | --- |
| **Data Relay Link** | Secure Remote Access + controlled outbound egress for isolated/restricted networks | [link.datarelay.run](https://link.datarelay.run/) | [GitHub](https://github.com/xdr-labs/frp-auto-deploy) |
