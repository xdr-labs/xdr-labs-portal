...
| --- | --- | --- | --- |
| **Data Relay Link** | 제한망/사설망의 Secure Remote Access + Controlled Egress | [link.datarelay.run](https://link.datarelay.run/) | [GitHub](https://github.com/datarelay-labs/datarelay-link) |
| **Data Relay Control** | Enterprise Data Flow Processing, Policy/Governance, Multi-Destination Delivery | [control.datarelay.run](https://control.datarelay.run/) | [GitHub](https://github.com/datarelay-labs/datarelay-control) |
...
| **OpenXDR KVM Installer** | KVM 기반 DP/Sensor/AIO 배포 | [kvm.xdr.ooo](https://kvm.xdr.ooo/ko) | [GitHub](https://github.com/xdr-labs/OpenXDR-KVM-Installer) |
...
| **Stellar Data Exporter** | Multi-Source Stellar Raw Data Query, Preview 및 File/Object/SFTP Export | [제품 페이지](/ko/products/stellar-data-exporter) · [사용 설명서](/ko/products/stellar-data-exporter-guide) | [GitHub](https://github.com/xdr-labs/stellar-data-exporter) |
