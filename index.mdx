...
<CardGroup cols={2}>
  ...
  <Card title="Stellar Alert + Case Syslog Daemon" icon="arrow-right-arrow-left" href="https://github.com/xdr-labs/Stellar-Case-Alert-to-Sylog">
    Long-running Python daemon that polls Stellar Cyber alerts and cases through the API and forwards them to a remote collector over TCP as newline-delimited JSON. Alert and case streams can be enabled independently.
  </Card>
</CardGroup>
...
| **Alert + Case Syslog Daemon** | Stellar alert/case forwarding | Repository README | [GitHub](https://github.com/xdr-labs/Stellar-Case-Alert-to-Sylog) |
