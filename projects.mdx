...
<CardGroup cols={2}>
  <Card title="Data Relay Link" icon="network-wired" href="https://link.datarelay.run/">
    ...
    **Source:** `datarelay-labs/datarelay-link`
  </Card>
  ...
  <Card title="Data Relay Control" icon="arrows-left-right" href="https://control.datarelay.run/">
    ...
    **Source:** `datarelay-labs/datarelay-control`
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Stellar Appliance CLI" icon="terminal" href="/products/stellar-appliance-cli">
    Unified `aella_cli` interface for KVM hosts created by the deployment tooling. It manages network settings, DNS/NTPsec, ACLs, host information, services, VM console/autostart, patching, and related appliance operations.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Stellar Data Exporter" icon="database" href="/products/stellar-data-exporter">
    Browser-based raw-data query and export utility for Stellar Cyber. It supports Root Scope and User Scope credentials, multi-source query, Preview, CSV/JSON/NDJSON output, browser download, S3-compatible storage, SFTP, file splitting, progress, and resumable remote export workflows.

    **Guide:** `xdr.ooo/products/stellar-data-exporter-guide` · **Source:** `xdr-labs/stellar-data-exporter`
  </Card>
