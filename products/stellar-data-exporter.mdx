...
- if Nginx or another reverse proxy publishes the exporter, require authentication/access control and restrict the outbound Stellar Cyber targets the exporter is allowed to reach
